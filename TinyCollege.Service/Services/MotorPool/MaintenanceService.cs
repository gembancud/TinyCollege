...
namespace TinyCollege.Service.Services.MotorPool
{
    public class MaintenanceService : BaseService
    {
        ...
        public List<Maintenance> GetMaintenances(string query)
        {
            var stringProperties = typeof(Maintenance).GetProperties().Where(prop =>
            ...
            return _context.Maintenances.Where(
                delegate (Maintenance x)
                {
